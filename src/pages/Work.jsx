...
const Work = () => (
  <div id='work' className='primary-2 :h-full'>
    <h1 className='mt-16 ml-7 text-green-500 '>These are some of my works</h1>
        ...
        return (
          <motion.div key={`#${name}`} className='mt-10 dark:bg-light-secondary/10 rounded-xl transition-all w-full lg:w-[470px] cursor-pointer shadow-2xl relative duration-300 app__work' initial='hidden' whileInView='show' variants={fadeIn(i)} viewport={{ once: true }}>
            <div className='app__work-img'>
              <img src={imageUrl} alt={name} className='object-cover w-full pt-5 mx-auto h-60' />
            </div>
            ...
            <div className='app__work-description'>
              <div className='flex items-center justify-between mx-auto w-9/10 lg:justify-normal lg:items-start'>
                <div className='mt-3 mb-2 font-bold'>{name}</div>
              ...
              <div className='flex mx-auto mb-5 text-gray-700 w-9/10 dark:text-dark-primary/70'>{description}</div>
            </div>
    ...
    <a className='flex justify-center w-3/5 mx-auto mt-20 mb-10 underline transition hover:text-light-secondary hover:dark:text-dark-accent' href='https://github.com/Sathishramesh1' target='_blank' rel='noreferrer'>
      See more on Github ...
    </a>
  </div>
);
